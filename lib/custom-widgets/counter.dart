...
import 'package:untitled/model/dish.dart';
...
class Counter extends StatefulWidget {
  ...
  Counter({Key? key, @required this.dish, @required int? initialValue}) : super(key: key);
...
class _CounterState extends State<Counter> {
  ...
  Widget build(BuildContext context) {
    ...
    updateDishInCart(){
      Dish cartDish = Dish(imageURL: widget.dish!['imageURL'].toString(), name: widget.dish!['name'].toString(),
